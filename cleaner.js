...
const delay = 10 * 1000; // Constant delay in milliseconds (10 seconds)
...
async function validateUsername() {
  ...
  if (currentUser.username !== youruser) {
    logMessage("Error: The entered username does not match the username associated with the provided token. Try again and make sure you entered your username correctly without the # and numbers after it.");
    return false;
  }
