...
const promptUserConfirmation = () => {
  ...
  return new Promise(resolve => rl.question('Are you sure you want to start deleting your messages? This action cannot be undone! Type "yes" if you wish to continue or you can enter any other key to cancel: ', answer => {
    rl.close();
...
let lastFetchedMessage = "", errorCount = 0, deletedMessagesCount = 0;
